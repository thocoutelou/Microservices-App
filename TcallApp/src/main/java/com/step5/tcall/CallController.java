...
public class CallController {
	...
	public String event(HttpServletRequest request, @RequestParam(value="service")String service) throws InterruptedException {
    	//Get the ip of the client
    	String ipSource = request.getRemoteAddr();
    	System.out.println("Request from: "+ipSource+" for the service:"+service);
    	Runner.sendEvent("ip="+ipSource+"&service="+service);
